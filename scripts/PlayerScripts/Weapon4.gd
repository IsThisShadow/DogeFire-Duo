...
# Spread variables
var spread_angle = 15.0  # Angle range for the shotgun spread (e.g., 15 degrees spread on either side)
var bullets_count = 5  # Number of bullets in the spread shot
...
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("shoot") and can_shoot:
		# Create multiple bullets for the spread shot
